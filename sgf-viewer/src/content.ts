...
export const pages: object =
{
    "home": {
        ...
        "description": [
            "<a target=\"_blank\" href=\"https://arxiv.org/pdf/2211.00241\">Past work</a> showed that superhuman Go AIs are vulnerable to simple adversarial strategies like a \"cyclic attack.\" Since Go AIs were never designed with security in mind, we wondered whether simple defenses could make KataGo robust. In this work, we test three natural defenses (illustrated below): <a href=\"/positional-adversarial-training#contents\">positional adversarial training</a> on hand-constructed board positions, <a href=\"/iterated-adversarial-training#contents\">iterated adversarial training</a> against successively stronger adversaries, and changing the network architecture to a <a href=\"/vit#contents\">vision transformer</a>.",
    ...
    "vit": {
        ...
        "content": [
            ...
            },
            {
                ...
                "description": [
                    "The original cyclic adversary <code>base-adversary</code>, with no additional training, already beats our ViT Go model in 2.5% of games at 512 visits of search. Explore games below, sampled to be equally balanced between wins and losses."
                ]
            },
            {
