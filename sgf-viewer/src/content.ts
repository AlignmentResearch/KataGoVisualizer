...
export const pages: object =
{
    "home": {
        ...
        "description": [
          ...
          "Our results suggest that achieving robustness is challenging, even in narrow domains such as Go. For more information on defenses, check out our latest <a target=\"_blank\" href=\"https://deploy-preview-131--alignmentfund.netlify.app/post/2024-05-go-defense/\">blog post</a> or <a target=\"_blank\" href=\"https://www.overleaf.com/read/smjxdnfxfzvw#5f0eb1\">paper</a>.",
        ],
        "content": []
    },
