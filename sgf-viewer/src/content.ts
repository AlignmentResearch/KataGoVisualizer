...
export const pages: object =
{
    "home": {
        ...
        "description": [
            ...
            "Since Go AIs were never designed with security in mind, we wondered whether simple defenses could make KataGo robust. We test three natural defenses (illustrated below): <a href=\"/positional-adversarial-training#contents\">positional adversarial training</a> on hand-constructed board positions, <a href=\"/iterated-adversarial-training#contents\">iterated adversarial training</a> against successively stronger adversaries, and changing the network architecture to a <a href=\"/vit#contents\">vision transformer</a>.",
