...
export const pages: object =
{
    "home": {
        ...
        "description": [
            ...
            `Click on the different sections above to view different examples of our adversaries in action. Some recommended places to start: the <a href="#???">Cyclic Attack</a> shows off our strongest adversary, the <a href="#???">Human Games</a> tab contains examples of humans beating both superhuman AIs and our adversaries, and the <a href="#???">Adversarial Training</a> tab details attempts to defend against our attack. All games on this website randomly selected unless otherwise specified.`,
