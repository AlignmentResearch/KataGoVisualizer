...
export const pages: object =
{
    "home": {
        ...
        "description": [
            ...
            "Our results suggest that achieving robustness is challenging, even in narrow domains such as Go. However, we did notice one positive signal: defending against any fixed static attack was quick and easy. We think it might be possible to leverage this property to build a working defense both in Go and other settings. For more information on defenses, check out our latest <a target=\"_blank\" href=\"https://far.ai/post/2024-06-go-defense/\">blog post</a> or <a target=\"_blank\" href=\"defense.pdf\">paper</a>."
        ],
        "content": []
    },
