...
export const pages: object =
{
    ...
    "game-analysis": {
        ...
        "content": [
            ...
            },
            {
                ...
                "description": [
                    "In this game, we find the victim's predicted win rate oscillates several times before the victim's group is captured at <MoveLink move=273>move 273</MoveLink>. At <MoveLink move=248>move 248</MoveLink>, the victim predicted it would win with 91% confidence, yet at its next turn at <MoveLink move=250>move 250</MoveLink> it has gone down to a <1% win rate prediction. At <MoveLink move=254>move 254</MoveLink>, it jumps back to a >99% win rate prediction. A few moves later, the victim's win rate prediction again fluctuates dramatically, hitting <1% at <MoveLink move=266>move 266</MoveLink>, 99% at <MoveLink move=268>move 268</MoveLink>, and <1% at <MoveLink move=272>move 272</MoveLink>.  After the capture on the following turn, the victim (correctly) predicts a <1% win rate until the end of the game."
                ]
            },
            {
    ...
    "activation-plots": {
        ...
        "description": ["In this page we share interactive plots visualizing activations over the 41 layers of KataGo models in cyclic situations. These correspond to the discussion in <a target=\"_blank\" href=\"https://arxiv.org/pdf/2211.00241#appendix.K\">Appendix K</a> of the paper."],
        "content": [
            {
        ...
        "content": [
            ...
            },
            {
                ...
                "description": [
                    ...
                    "Beginning on <MoveLink move=70>move 70</MoveLink>, Kellin (white) starts to set up a position to receive a gift. In moves <MoveLink move=100>100</MoveLink> through <MoveLink move=142>142</MoveLink>, white pushes further into black’s territory, making sure that the gift will result in a very large swing in points. Then starting on <MoveLink move=154>move 154</MoveLink>, white sets up another place for a gift. Black offers a gift on <MoveLink move=177>move 177</MoveLink>, but white does not accept yet because black threatens to capture four stones on <MoveLink move=179>move 179</MoveLink>. Note that this is the only place where black has a threat; white is careful to play very solidly and minimize potential threats, to be able to capitalize on the gift (noting that if there are lots of threats, the victim can use them to prevent a repeated board position and save themselves from the positional superko rule).",
    ...
    "iterated-adversarial-training": {
        ...
        "description": [
            "We performed an iterated adversarial training procedure that alternately trains a victim <code>v</code><sub><code>n</code></sub> and an adversary <code>a</code><sub><code>n</code></sub>. After nine iterations, our final victim <code>v</code><sub><code>9</code></sub> remains vulnerable both to a freshly trained <a href=\"#v9-vs-atari\">\"atari\" attack</a> and the <a href=\"#v9-vs-a9\">\"iterated\" attack</a> <code>a</code><sub><code>9</code></sub>. These attacks are described in the following sections. You can also explore games from <a href=\"/iterated-adversarial-training-per-iteration#contents\">intermediate steps of the iterated adversarial training</a>."
        ],
        "content": [
            {
            ...
            },
            {
                ...
                "description": [
                    ...
                    "In the first game, on <MoveLink move=39>move 39</MoveLink>, we see the adversary complete a diamond, \"ponnuki\"-like shape of 4 stones in the center. This will become the center of the cyclic group, and is a distinctive shape of this adversary. In the subsequent moves, we see it play around that area, letting the victim separate off and surround the diamond. By <MoveLink move=80>move 80</MoveLink>, the cyclic part of the victim's group is completed. After that, the adversary slows down, letting the victim expand the cyclic group and only gradually surrounding it. Eventually, on <MoveLink move=193>move 193</MoveLink>, the adversary completes the encirclement. At this point the cyclic group is already lost, though the final capture takes place later on <MoveLink move=231>move 231</MoveLink>."
                ]
            }
        ]
    },
    "vit": {
        ...
        "description": [
          ...
          "We validate the strength of our ViT model by playing against KataGo, playing against members of the public on KGS, and commissioning professional games. Our games against KataGo (<a target=\"_blank\" href=\"https://arxiv.org/pdf/2406.12843.pdf#subsection.G.1\">Appendix G.1</a>) give an estimated <a target=\"_blank\" href=\"https://www.goratings.org/en/\">goratings.org Elo</a> of 3877 at 32,768 visits, comparable to the strongest professional players. We also deployed the ViT bot <code>ViTKata001</code> on the KGS Go server, ranking as <a target=\"_blank\" href=\"https://archive.is/J4Fjz\">one of the top players and beating several KataGo bots</a>. Finally, our ViT bot won two out of three games commissioned against Go professionals.",
        ...
        "content": [
            {
                ...
                "description": [
                    "After a close early game between ViT (black) and Yang (white), a complicated fight develops on the left side and center, starting around <MoveLink move=52>move 52</MoveLink>. According to KataGo, this move would have been better as a cap two lines to the right of black's stone on the middle of the left side, or one line below the cap. If so, the game would remain even, even slightly advantageous for white. Also, black <MoveLink move=55>55</MoveLink> was a mistake and should have been the cut where white played <MoveLink move=56>56</MoveLink>; if now instead of connecting at <MoveLink move=56>56</MoveLink> white pressures black's stones above by playing one line above and to the left of the connection, white will again have a very slight advantage.",
                    "Nonetheless, after these moves the game remained close. The most deciding move was that white should have played <MoveLink move=66>66</MoveLink> directly below white's leftmost stone, to probe how black connects the two stones above. If black plays the best, empty triangle connection, then a complicated ko situation may develop but the game remains only marginally favored for black, whereas other connections will tilt the game in white's favor. But after <MoveLink move=66>66</MoveLink> in the game, black threatens to cut off a stone with <MoveLink move=67>67</MoveLink>, and the timing to probe the connection on the left is lost. In the end, with <MoveLink move=92>92</MoveLink> white is able to live, but black's position on the outside is better and black has a decent advantage.",
                    "After that, some very slightly suboptimal moves on the lower side reinforced black's lead. Black <MoveLink move=107>107</MoveLink> was a mistake, as black should have played a diagonal move on the third line from the stone below it. But white's clamp at <MoveLink move=108>108</MoveLink> failed to punish it; white should have played the turn on the 3-4 point, though the game would still have been very hard. After this, there were essentially no opportunities for white to recover."
                ]
            },
            {
                ...
                "victim": "<code>ViT-victim</code>, 65536 visits, 64 search threads",
                "description": [
                    "Moves <MoveLink move=8>8</MoveLink> through <MoveLink move=12>12</MoveLink> from black (Li) initiate the <a target=\"_blank\" href=\"https://senseis.xmp.net/?FlyingKnifeJoseki\">\"flying dagger\"</a> joseki (opening corner pattern). This is a very complicated joseki that has been a known weakness of past AIs. KataGo trained on manually constructed positions to fix this weakness, which are not included in our training data. It appears this weakness emerged in our ViT system as well. Through <MoveLink move=33>move 33</MoveLink>, white (ViT) plays some slight inaccuracies, leading to a small advantage for black. According to KataGo, <MoveLink move=34>move 34</MoveLink> is a more substantial mistake; white should have captured black's single stone instead. <MoveLink move=36>36</MoveLink> is also a mistake; white had several better options including the same capture. So is <MoveLink move=38>38</MoveLink>, as white should have played one space below, or even better given up the left and played for the outside with a cap two spaces to the right of black's top stone on the left. After the left side of the board is stabilized with black <MoveLink move=61>61</MoveLink>, black has a considerable advantage.",
                    "After this, white recovers slightly in the lower right, but black maintains a solid lead. At <MoveLink move=104>104</MoveLink>, white again misses several better options. Through <MoveLink move=130>130</MoveLink>, white captures four stones but loses the top right corner, which does not help white catch up. With <MoveLink move=134>134</MoveLink>, white attempts to live in black's area on the top part of the board, but black plays accurately and white dies, sealing the game."
                ]
            },
            {
                ...
                "victim": "<code>ViT-victim</code>, 65536 visits, 64 search threads",
                "description": [
                    "After ViT's big loss in the flying dagger joseki in the preceding game, Li agreed to play a game where he would avoid that pattern. In this game, on <MoveLink move=11>move 11</MoveLink>, black (ViT) offers a chance to initiate the flying dagger pattern, but white (Li) declines by playing at <MoveLink move=12>12</MoveLink>, leading to a much less complicated pattern which is fairly balanced but very slightly worse than the flying dagger according to KataGo.",
                    "The game then remains balanced for many moves, with both sides playing well and fighting back and forth over narrow margins. On <MoveLink move=71>move 71</MoveLink>, black should have continued in the top right but makes a significant mistake by playing on the bottom side. This allows white to guarantee the safety of the top right through <MoveLink move=76>76</MoveLink>, giving a reasonable though not tremendous advantage. However, at <MoveLink move=100>move 100</MoveLink>, white should have played at <MoveLink move=102>102</MoveLink> directly; exchanging 100 for <MoveLink move=101>101</MoveLink> lost some options, and the game becomes closer again. Still, white maintains the advantage.",
                    "Over the following moves, black gradually reduces white's advantage, and then on <MoveLink move=118>move 118</MoveLink> white misses some opportunities on the lower side and center, making the game virtually even again. <MoveLink move=131>Move 131</MoveLink> is a nice tesuji and the only way for black to save the corner cleanly. White begins to develop a small lead again step-by-step, but loses it with <MoveLink move=152>152</MoveLink>, which misses the timing to reduce the center after black reinforces with <MoveLink move=153>153</MoveLink>. Finally, <MoveLink move=164>164</MoveLink> misses a chance to play a complicated sequence of reducing moves on the bottom and center. With <MoveLink move=165>165</MoveLink>, black fixes the largest remaining gap in the center. Thus, after a long game where white was sometimes even and sometimes favored, black (ViT) was able to close the game in the end."
                ]
            },
            {
            ...
            },
            {
                ...
                "description": [
                    ...
                    "In the first game, the adversary stakes out the center on <MoveLink move=17>move 17</MoveLink>, for constructing its group inside the cyclic group, which is fully formed by <MoveLink move=49>move 49</MoveLink>. After that, the victim surrounds that central group, completing the cyclic group on <MoveLink move=248>move 248</MoveLink>, while the adversary surrounds it from the outside. This leads to a very dense board, with adversary stones positioned low around the edges, and the victim controlling a huge center, mostly filled by the cyclic group and its encirclement. This pattern is typical for this adversary. On <MoveLink move=255>move 255</MoveLink>, the victim captures the inside group, but after that the adversary reenters the space and establishes a new inside group. Although not universal, this behavior mirrors tactics also observed with the original cyclic adversary. Finally, at <MoveLink move=283>move 283</MoveLink>, the victim is doomed, and the cyclic group is taken off the board at <MoveLink move=335>move 335</MoveLink>."
                ]
            },
            {
                ...
                "victim": "<code>ViT-victim</code>, 65536 visits, 64 search threads",
                "description": [
                    "A Go expert (Kellin Pelrine) was also able to use a cyclic attack to beat our ViT-victim. The game is shown below. Through <MoveLink move=56>move 56</MoveLink>, white (Kellin) sets up a loosely surrounded square group destined to be the inside of the cyclic group. This follows the shape used in some of the wins of our original cyclic adversary against this victim. In subsequent moves, white gradually surrounds the cyclic group, with a particular focus on making sure the surrounding groups have lots of liberties so that black will have to see its group is in danger early on to save it. Beginning around <MoveLink move=176>move 176</MoveLink>, white fills in the cyclic group's liberties, as well as pressing black to make the last connections that complete the cyclic shape. Finally, after <MoveLink move=208>208</MoveLink>, black's fate is sealed. Black (ViT) plays on several more moves hoping for white to make a mistake, but ultimately resigns."
                ]
            }
        ]
    },
