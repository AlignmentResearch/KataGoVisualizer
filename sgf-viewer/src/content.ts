    ...
    "positional-adversarial-training": {
        ...
        "content": [
            ...
            },
            {
                ...
                "description": [
                    "A Go expert (Kellin Pelrine) studied this attack and was able to learn and implement it to beat KataGo. In the game (shown below), there were a number of key components to doing this successfully. The operation begins with the opening pattern with 3-3 points on moves <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 3)'>3</a> and <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 9)'>9</a>, inducing KataGo (white) to play on the sides through <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 18)'>move 18</a>, which sets the stage to build the distinctive inside group shape. That operation begins in earnest with the cap at <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 19)'>move 19</a>. <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 27)'>Move 27</a> is an abnormal move designed to induce <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 28)'>28</a> immediately and <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 36)'>36</a> later; an extension like this can be seen in some of our AI adversary's games. <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 41)'>41</a> induces <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 42)'>42</a>, and through <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 47)'>47</a> the initial outline of the group is completed.",
                    "<a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 59)'>Move 59</a> begins the second phase, to induce the victim to create an eye for its cyclic group. <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 69)'>69</a> pushes white to capture a stone to make this happen, and <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 71)'>71</a> invites <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 72)'>72</a> which avoids the possibility of the victim making a false eye. The eye is finally completed when white captures at <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 108)'>108</a>.",
                    "In the meantime, Kellin (black) begins to surround the cyclic group and invite connections to complete it. At the same time, with <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 149)'>149</a> and <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 173)'>173</a>, black separates what will be an extension of the cyclic group from the rest of white's stones.  With the connection at <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 232)'>232</a>, the cycle itself is virtually complete. However, the inside shape does not yet have the distinctive double cut pattern. So after playing more moves to surround the cyclic group through <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 249)'>249</a>, black buys some time with moves like <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 251)'>251</a> and <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 259)'>259</a>, waiting for white to attack the inside group. This happens with <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 260)'>260</a>, and the double cut is completed with <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 266)'>266</a>.",
                    "At this point, the last phase begins. In a number of failed attempts, all the steps so far were insufficient to lead to a successful capture without the victim seeing the danger. To divert the victim's attention, black sets up a situation where the last chance to save the cyclic group will also be doing something else—specifically, capturing its tail. Black plays some preparatory moves at <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 273)'>273</a> and <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 275)'>275</a>, which ensure black will not run into a liberty shortage with his own group. Finally, at <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 277)'>move 277</a>, black threatens to cut off white's tail, while at the same time filling liberties of the cyclic group. If white connects, the entire cyclic group will die. KataGo (white) seems to recognize that connecting will lead to disaster, and plays elsewhere, letting black capture with <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 279)'>279</a>. Now, white has a final chance to save the cyclic group by capturing part of the inside group. Although capturing the tail is a huge gain for black, white still has a considerable lead if the cyclic group survives. However, white plays away at <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 280)'>280</a>, letting black fill another liberty with <a class='clickable' onclick='setMove(`dec23-vs-human-cyclic`, 281)'>281</a>. Now white can no longer capture the inside group before black captures the cyclic group, so white loses.",
        ...
        "content": [
            {
                ...
                "description": [
                    ...
                    "This adversary starts by inducing the victim to form bamboo joints: pairs of stone separated by two empty spaces. In normal games, these are often efficient shapes due to their strong connections. In the first game here, the first bamboo joint is formed on <a class='clickable' onclick='setMove(`v9-vs-atari`, 24)'>move 24</a> between that white stone, the one next to it, and the two below those. Additional joints are formed on <a class='clickable' onclick='setMove(`v9-vs-atari`, 28)'>move 28</a> and <a class='clickable' onclick='setMove(`v9-vs-atari`, 52)'>52</a>. By <a class='clickable' onclick='setMove(`v9-vs-atari`, 102)'>move 102</a>, a large cyclic group emerges, another hallmark of this adversary’s strategy. For over 100 moves, the adversary systematically encloses the cyclic group. Throughout, this adversary often leaves many stones \"in atari\" in Go terminology, what might be called hanging pieces in chess – stones that could be instantly captured if the victim opts to. At <a class='clickable' onclick='setMove(`v9-vs-atari`, 217)'>move 217</a>, the attack enters the final phase: the adversary threatens to split the bamboo joints. The victim connects at <a class='clickable' onclick='setMove(`v9-vs-atari`, 218)'>218</a> and <a class='clickable' onclick='setMove(`v9-vs-atari`, 220)'>220</a>, each move reducing the overall group’s liberties. A fatal mistake is committed at <a class='clickable' onclick='setMove(`v9-vs-atari`, 222)'>move 222</a>, allowing the adversary to capture everything with <a class='clickable' onclick='setMove(`v9-vs-atari`, 223)'>move 223</a>."
                ]
            },
            {
