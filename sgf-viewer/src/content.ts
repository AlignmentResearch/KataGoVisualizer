        ...
        "content": [
            ...
            },
            {
                ...
                "description": [
                    ...
                    "In the first game, on <a class='clickable' onclick='setMove(`v9-vs-a9`, 39)'>move 39</a>, we see the adversary complete a \"ponnuki\" shape of 4 stones in the center. This will become the center of the cyclic group, and is a distinctive shape of this adversary. In the subsequent moves, we see it play around that area, letting the victim separate off and surround the ponnuki. By <a class='clickable' onclick='setMove(`v9-vs-a9`, 80)'>move 80</a>, the cyclic part of the victim's group is completed. After that, the adversary slows down, letting the victim expand the cyclic group and only gradually surrounding it. Eventually, on <a class='clickable' onclick='setMove(`v9-vs-a9`, 193)'>move 193</a>, the adversary completes the encirclement. At this point the cyclic group is already lost, though the final capture takes place later on <a class='clickable' onclick='setMove(`v9-vs-a9`, 231)'>move 231</a>."
                ]
            }
        ]
    },
