...
def tensorboard_session_viewer():
    '''
    Tensorboard sessions are not tied to Streamlit sessions (becauses I couldn't figure out
    ...
    if tb_sessions:
        ...
        for sesh in tb_sessions:
            col1, col2, col3, col4 = st.columns([5, 1, 5, 1]) # New columns on each row for vertical alignment
